...
function MenuPrixDeroulants(props) {
  ...
  var Filter = e => {
    e.preventDefault();
    props.onChangePrixValueFilterBar(e.target.dataset.value);
    var copyState = { ...showMenuPrice };
  ...
  return showMenuPrice.show ? (
    <div className="menuDeroulantContainer2">
      <div className="priceFilter" onClick={handleChange2}>
        {showMenuPrice.value}
      </div>
      ...
      <div
        className="langageListItem2"
        data-value="TOUS LES PRIX"
        onClick={Filter}
      >
        TOUS LES PRIX
      </div>
